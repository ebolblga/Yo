...
Источник: [Омонимы -Википедия](https://ru.wikipedia.org/wiki/%D0%9E%D0%BC%D0%BE%D0%BD%D0%B8%D0%BC%D1%8B).

## Алгоритм
В предыдущей итерации проекта поступило предложение отсортировать итоговую таблицу по популярности слов. Для того, чтобы это было возможно для алгоритма поиска пар была использованна база данных, включающая в себя частоту возникновения слов: [Baksalyar/mc.hertzbeat.ru-Frequency-Dictionaries](https://github.com/Baksalyar/mc.hertzbeat.ru-Frequency-Dictionaries/) - **480092** слова.
...
После фильтрации остался список из всего **198** пар слов, первые 10 пар представлены ниже, полная же версия находится в [`/output/result.md`](https://github.com/ebolblga/Yo/blob/master/output/result.md).
...
### Примеры предложений
Можно использовать силы LLM там, где LLM действительно хороши - составление текста. Для этого была выбрана модель [ChatGPT-5](https://chatgpt.com/):
...
— с ё: «передохнём (отдохнём)» — все отдохнём.<br />
— с е: «передохнем (умрём)» — все поумираем.


## Ёфикаторы и деёрификаторы
Уже после завершения проекта я открыл для себя кроличью норму в виде ёрификаторов...
...
Источник: [Ёфикатор - Википедия](https://ru.wikipedia.org/wiki/%D0%81%D1%84%D0%B8%D0%BA%D0%B0%D1%82%D0%BE%D1%80).
...
- [e2yo/eyo](https://github.com/e2yo/eyo) — ёфикатор с открытым кодом на Node.js
- [rin-nas/php-yoficator](https://github.com/rin-nas/php-yoficator) — ёфикатор с открытым кодом на PHP
- [vgiv/yo](https://github.com/vgiv/yo) — ёфикатор с открытым кодом на Pascal
- [yomaker](https://yomaker.ru/) — cайт «главного ёфикатора России» Виктора Трофимовича Чумакова
- [Ёфикатор](https://textometr.ru/yoficator) — онлайн-ёфикатор
- [Ёфицирующие скрипты](http://python.anabar.ru/yo.htm) — скрипты для текстовых редакторов VIM и XEmacs
- [Пишите по-русски](http://info-7.ru/RusYaz/RusYaz.shtml) — макрос для документов MS Word с функцией ёфикации
...
## [Лицензия](https://github.com/ebolblga/Yo/blob/master/LICENSE.md)
