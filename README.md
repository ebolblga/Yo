...
После фильтрации остался список из всего **198** слов, первые 5 слов представлены ниже, полная же версия находится в [`/output/result.md`](https://github.com/ebolblga/Yo/blob/master/output/result.md).
